            ...
            <div class="row g-3  gap-6 py-2">
                ...
                <div class="align-content-center   mt-3 mb-5">
                    <div class="p-2 pb-0 mt-3 mb-2  text-center">
                        ...
                        <h1 class="" >Your Courses , <span style="color: #fb873f"  class="">{{ $user->name }}</span></h1>
                    </div>
               ...
               <img  class="img-fluid" src="{{ asset("storage/images/". $image) }}" alt="">
                        ...
                        @endif
                            ...
                            <div class="d-flex mt-3 mb-3">
                                ...
                                <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="{{ route("mycourse.show",$course->id) }}"> Get Course </a><i class="fa fa-chevron-right me-2 fs-10"></i></small>
                            </div>
                        </div>
                    </div>
