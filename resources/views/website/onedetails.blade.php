   ...
   --}}
                        ...
                        @endif
                            ...
                            <div class="p-2 pb-0 mt-3 mb-2">
                                ...
                                <h5 class="" style="color: #fb873f"><a style="color: #fb873f" href="" class="">{{ $course->name }} </a></h5>
                            </div>
                            <div class="p-2 pb-0 ">
                            ...
                            <div class="p-2 pb-0 ">
                                ...
                                <h3  style=" font-size:20px">Email : <span style="color: gray;">{{ $teacher->email }}</span> </p></h3>
                            </div>
                            <div class="p-2 pb-0 ">

                                <h5 ><a href="{{ route("Courses.show",$course->category["id"]) }}">{{ $course->category["name"]}} </a></h5>
                            </div>
                            ...
                            <div class="d-flex mt-3 mb-3">
                                ...
                                <small class=" text-primary py-1 px-2 fw-bold fs-6" style="float:right;"><a href="{{ route('course.teachershow', ['courseId' => $course->id, 'teacherID' => $teacher->id]) }}">
                                    Details
